    ...
    <div className="rules">
      ...
      {showRules && (
        <div className="rules-content">
          ...
          Remember, reaching 0 points means you've lost the bedtime battle, requiring a fresh start to achieve victory once more.<br /><br />
          Are you ready to embark on this bedtime journey? Choose wisely as you scroll through the bedtime items that will lead your child into dreamland.
          </p>
        </div>
      )}
    </div>
